...
Route.group(() => {
  ...
  Route.get('/mapas/:id', 'MapasController.obtenerMapa').middleware('checkRole:1,2')
  Route.put('/mapas/modificar/:id', 'MapasController.actualizarMapa').middleware('checkRole:1,2')
  Route.delete('/mapas/eliminar/:id', 'MapasController.eliminarMapa').middleware('checkRole:1')
